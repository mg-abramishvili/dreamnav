        ...
        <swiper v-if="events.length"
            ...
            <swiper-slide v-for="(event, index) in events">
                <div class="event-slide">
                    ...
                    <div v-html="event.description" class="event-slide-desc"></div>
                </div>
            </swiper-slide>
        </swiper>

        <button @click="prev()" class="events-navigation events-navigation-prev">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"/>
            </svg>
        </button>
        <button @click="next()" class="events-navigation events-navigation-next">
